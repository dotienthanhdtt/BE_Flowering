...
export const languageSeedData: LanguageSeedData[] = [
  ...
  { code: 'vi', name: 'Vietnamese', nativeName: 'Tiếng Việt', levelFramework: 'FRAMEWORKLESS' },
  ...
  { code: 'th', name: 'Thai', nativeName: 'ไทย', levelFramework: 'FRAMEWORKLESS' },
];
...
export const seedLanguagesQuery = `
  ...
  VALUES
    ...
    ('vi', 'Vietnamese', 'Tiếng Việt', true, 'FRAMEWORKLESS'),
    ...
    ('th', 'Thai',       'ไทย',        true, 'FRAMEWORKLESS')
